...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
  ...
  <dl>
   <dt><a href="buyinfo.html"> <img src="${contextPath}/prolist/${product.img}" /></a></dt>
   <dd>
     <h3>${product.price}</h3>
     <div class="phonePars">
     ${product.introduce}
  ...
  <div class="jiaru-shoucang">
      <span class="jiaruCar" name="${product.id}">加入购物车</span>
  ...
  <!--  <dl>
    <dt><a href="buyinfo.html"><img <img src="${contextPath}/prolist/${user.imgs}" /></a></dt>
    <dd>
     <h3>￥4800.00</h3>
     <div class="phonePars">
