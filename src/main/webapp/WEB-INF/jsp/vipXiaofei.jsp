...
<li><a href="#" class="lan">中文</a></li>
 ...
 <div class="vipBox">
  <div class="vipLeft">
   ...
   <dl class="vipNav">
    <dt class="vip_1 vipCur">买家中心</dt>
     <dd><a href="${contextPath}/order">我的订单</a></dd>
  ...
  <div class="vipRight">
   ...
   <c:forEach items="${order.products}" var="aa">
    <tr>
     <th>订单编号</th>
     <td>${order.id}</td>
    </tr>
    ...
    <tr>
     ...
     <td>￥${order.shopCount}</td>
      ...
      <tr>
     <th>订单总价</th>
     <td>￥${order.shopCount*aa.price}</td>
    </tr>
    <tr>
     <th>订单信息</th>
     <td> 
${order.address.name}，${order.address.phone}，${order.address.area}，${order.address.address},${order.address.zipCode}</td>
    </tr>
    <tr>
     <th>商家</th>
     <td>纯绿商城</td>
